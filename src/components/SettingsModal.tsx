...
export const SettingsModal: React.FC<SettingsModalProps> = ({ state, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md select-none animate-fadeIn">
      <div className="relative w-full max-w-sm game-card rounded-3xl p-5 shadow-2xl flex flex-col text-white max-h-[90vh] overflow-y-auto border border-white/15">
        ...
        <div className="flex items-center justify-between pb-3.5 border-b border-white/10 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] text-zinc-400 font-mono">Street Striker Pro v2.5</span>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Notification Toast */}
        {toastMessage && (
          <div className="mb-3 px-3 py-2 rounded-xl bg-emerald-950/90 border border-emerald-500 text-emerald-300 font-bold text-xs text-center shadow-lg animate-pulse">
            {toastMessage}
          </div>
        )}
        ...
        <div className="space-y-3.5">
          {/* 1. Language Selector */}
          <div className="bg-black/50 rounded-2xl p-3.5 border border-white/10 space-y-2.5 shadow-inner">
              ...
              {languages.map((l) => {
                ...
                return (
                  <button
                    ...
                    className={`py-2 px-1 rounded-xl text-[10px] font-black flex flex-col items-center justify-center transition-all border ${
                      isSelected
          ...
          {/* 2. Audio & Performance */}
          <div className="bg-black/50 rounded-2xl p-3.5 border border-white/10 space-y-3 shadow-inner">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-white/5">
              ...
              <span className="text-[10px] font-mono text-emerald-400 font-black bg-emerald-950/80 px-2.5 py-0.5 rounded-lg border border-emerald-600/40">
                60 FPS
              </span>
            </div>
          </div>
          ...
          <div className="bg-black/50 rounded-2xl p-3.5 border border-white/10 space-y-2.5 shadow-inner">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="py-2.5 px-3 rounded-2xl bg-neutral-800 hover:bg-neutral-700 text-zinc-200 text-xs font-black flex items-center justify-center gap-1.5 border border-zinc-700 active:scale-95 transition-all shadow-sm"
              >
          ...
          <button
            ...
            className="w-full py-3 rounded-2xl bg-rose-950/60 hover:bg-rose-900 border border-rose-800 text-rose-300 font-black text-xs flex items-center justify-center gap-2 transition-all active:scale-95 shadow-md"
          >
